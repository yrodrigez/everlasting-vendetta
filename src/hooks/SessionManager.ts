import {getCookie, getLoggedInUserFromAccessToken, logout} from "@/util";
import {toast} from "sonner";
import {BNET_COOKIE_NAME, EV_COOKIE_NAME, LOGIN_URL, LOGIN_URL_TEMPORAL} from '@/util/constants';
import {type Character} from "@/components/characterStore";
