                    ...
                    <div
                        ...
                        <div className="table-row-group bg-dark">
                            {usersWithRoles.map(({ user, assignedRoles }) => {
                                const tempRoleId = userRoleSelections[user.id] || ""
                                return (
                                        ...
                                        <div className="table-cell p-2 border-b border-stone">
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    setUserRoleSelections(prev => ({ ...prev, [user.id]: "" }))
                                                }}
                        ...
                        <div className="table-row-group bg-dark">
                            {rolesWithPermissions
                                ...
                                .map(({ role, permissions }) => {
                                    const newPermission = rolePermissionInputs[role.id] || ""
                                    return (
                                            ...
                                            <div className="table-cell p-2 border-b border-stone">
                                                ...
                                                >
                                                    <input
                                                        type="text"
                                                        value={newPermission}
                                                        onChange={(e) => setRolePermissionInputs(prev => ({ ...prev, [role.id]: e.target.value }))}
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            setRolePermissionInputs(prev => ({ ...prev, [role.id]: "" }))
                                                        }}
